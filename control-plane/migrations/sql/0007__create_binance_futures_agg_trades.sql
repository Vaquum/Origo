CREATE TABLE IF NOT EXISTS {{DATABASE}}.binance_futures_agg_trades (
    futures_agg_trades_id UInt64 CODEC(Delta(8), ZSTD(3)),
...
ORDER BY (toStartOfDay(datetime), futures_agg_trades_id)
SAMPLE BY futures_agg_trades_id
SETTINGS
