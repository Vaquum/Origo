...
from origo_control_plane.s19_p5_no_miss_completeness_proof import run_s19_p5_proof
...
def main() -> None:
    p5_payload = run_s19_p5_proof()
    payload = {
        'proof_scope': (
            'Slice 19 S19-G3 reconciliation/quarantine guardrail verification '
            'for Bybit canonical ingest (fail-loud gap detection and quarantine block)'
        ),
    ...
    output_path = _SLICE_DIR / 'proof-s19-g3-reconciliation-quarantine.json'
