"""Perp aggregate latest dollar-bar formula: table names over the generic bar math."""
...
from .perp_agg_dollar_klines import DOLLAR_KLINE_SIZE

LATEST_DOLLAR_KLINES_TABLE_NAME = 'binance_perp_aggtrades_dollar_klines_latest'
