"""Perp aggregate dollar-imbalance formula: table names over the generic bar math."""
...
DOLLAR_IMBALANCE_KLINES_TABLE_NAME = 'binance_perp_aggtrades_dollar_imbalance_klines'
