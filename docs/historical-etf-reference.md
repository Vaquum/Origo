...
- `etf_ishares_ibit_daily`:
  ...
  - snapshot-only issuers with no valid archived artifacts have no historical range yet; Origo treats that as an explicit empty claim, not as silently completed history
