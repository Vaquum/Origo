CREATE TABLE IF NOT EXISTS {{DATABASE}}.bitcoin_network_hashrate_estimate (
    ...
    observed_interval_seconds UInt64 CODEC(Delta(8), ZSTD(3)),
    hashrate_hs Float64 CODEC(Delta, ZSTD(3)),
