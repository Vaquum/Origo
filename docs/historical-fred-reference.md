# Historical FRED API Reference

- Last updated: 2026-03-12
- Scope: FRED historical series metrics dataset (`fred_series_metrics`)
...
- `503`: runtime/backend/warning-evaluation/alert-audit failures
