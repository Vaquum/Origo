"""Spot aggregate aligned-table formula: table names over the generic bar math."""
...
BINANCE_SPOT_AGG_DATASET_SOURCE = 'binance_spot_aggtrades'
...
def _insert_partition_rows(
    ...
    insert_aligned_partition_rows(
        ...
        dataset_source=BINANCE_SPOT_AGG_DATASET_SOURCE,
    )
