...
def _project_stream_aligned(
    *,
    ...
    normalized_partitions = sorted(
        {
            _require_non_empty(partition_id, label='partition_id')
...
def project_bitcoin_block_headers_aligned(
    *,
    client: ClickhouseClient,
    database: str,
    partition_ids: list[str] | set[str],
    ...
    return _project_stream_aligned(
        ...
        projector_id='bitcoin_block_headers_aligned_1s_v1',
...
def project_bitcoin_block_transactions_aligned(
    *,
    client: ClickhouseClient,
    database: str,
    partition_ids: list[str] | set[str],
    ...
    return _project_stream_aligned(
        ...
        projector_id='bitcoin_block_transactions_aligned_1s_v1',
        partition_ids=partition_ids,
        run_id=run_id,
        projected_at_utc=projected_at_utc,
        batch_size=batch_size,
...
def project_bitcoin_mempool_state_aligned(
    *,
    client: ClickhouseClient,
    database: str,
    partition_ids: list[str] | set[str],
    ...
    return _project_stream_aligned(
        ...
        projector_id='bitcoin_mempool_state_aligned_1s_v1',
        partition_ids=partition_ids,
        run_id=run_id,
        projected_at_utc=projected_at_utc,
        batch_size=batch_size,
