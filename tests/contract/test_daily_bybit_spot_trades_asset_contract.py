...
def test_daily_bybit_asset_recomputes_proof_after_writer_repair(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv('CLICKHOUSE_HOST', 'clickhouse')
    monkeypatch.setenv('CLICKHOUSE_PORT', '9000')
        ...
        def compute_canonical_partition_proof_or_raise(
            ...
            **_kwargs: Any,
            ...
            return PartitionCanonicalProof(
                ...
                first_offset_or_equivalent='8f725b02-daf4-5af4-aa66-da3e04563a5a',
                last_offset_or_equivalent='legacy-tail',
                canonical_offset_digest_sha256='offset-digest-legacy',
                canonical_identity_digest_sha256='identity-digest-legacy',
                gap_count=0,
                duplicate_count=0,
            )
