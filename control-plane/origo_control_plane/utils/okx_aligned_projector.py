...
_PROJECTOR_ID = 'okx_spot_trades_aligned_1s_v1'
...
class OKXAlignedProjectorSummary:
...
def _aggregate_summaries(summaries: list[OKXAlignedProjectorSummary]) -> OKXAlignedProjectorSummary:
    return OKXAlignedProjectorSummary(
...
def project_okx_spot_trades_aligned(
    *,
    client: ClickhouseClient,
    database: str,
    ...
    summaries: list[OKXAlignedProjectorSummary] = []
