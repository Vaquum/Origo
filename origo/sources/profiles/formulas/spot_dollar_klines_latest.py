"""Relocated verbatim from origo/assets/refresh_binance_spot_dollar_klines_latest_origo.py; the SQL and arithmetic are unchanged."""

from datetime import datetime, timedelta
from origo.assets.create_origo_database import ClickHouseClientProtocol
from .spot_dollar_klines import DOLLAR_KLINE_SIZE
